...
<div class="card p-4 shadow-lg border-radius-xl">
    <h5 class="mb-4">Log Kunjungan: Tamu Umum</h5>
    ...
    <div class="table-responsive">
        <table id="tabelUmum" class="table admin-table align-items-center mb-0">
            <thead>
                <tr>
            ...
            <tbody>
                <?php $no = 1; $modals = ''; while ($t = mysqli_fetch_assoc($query)) : ?>
                    <?php $modalId = 'detailUmum' . (int) $t['id']; ?>
                    <tr>
                        ...
                        <td class="text-center">
                            <div class="action-group">
                                <?php if ($role === 'resepsionis' && $t['status'] === 'pending'): ?>
                                    <a href="approve.php?id=<?= (int) $t['id']; ?>&aksi=terima&asal=umum" class="guest-action approve" title="Setujui"><i class="fas fa-check"></i></a>
                                    <a href="approve.php?id=<?= (int) $t['id']; ?>&aksi=tolak&asal=umum" class="guest-action reject" title="Tolak"><i class="fas fa-times"></i></a>
                                <?php endif; ?>
                        ...
                        <div class="modal-dialog modal-dialog-centered modal-lg">
                            <div class="modal-content">
                                <div class="modal-header border-0">
                                    <h5 class="modal-title">Detail Tamu Umum</h5>
...
$(function() {
    $('#tabelUmum').DataTable({
        ...
        language: {
            ...
            search: 'Cari:',
            searchPlaceholder: 'Nama, no HP, status...',
